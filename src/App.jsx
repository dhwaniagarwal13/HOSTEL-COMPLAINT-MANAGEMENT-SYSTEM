    ...
    <AuthProvider>
      <Router future={{ v7_startTransition: true, v7_relativeSplatPath: true }}>
        <Routes>
          ...
          <Route path="/staff-details" element={<ProtectedRoute allowedRoles={['staff']}><ComplaintDetailsStaff /></ProtectedRoute>} />
          
          {/* Admin Routes */}
          <Route path="/admin" element={<ProtectedRoute allowedRoles={['admin']}><AdminManagementPanel /></ProtectedRoute>} />
          <Route path="/analytics" element={<ProtectedRoute allowedRoles={['admin']}><AdminAnalyticsDashboard /></ProtectedRoute>} />
